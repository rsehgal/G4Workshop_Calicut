...
Event_DetectorConstruction::Event_DetectorConstruction() {}

Event_DetectorConstruction::~Event_DetectorConstruction() {}

G4VPhysicalVolume *Event_DetectorConstruction::Construct() {
  ...
  // Event_SensitiveDetector* detector = new Event_SensitiveDetector("SensitiveDetector");
